...
memset(screen_buffer, 1, sizeof(screen_buffer));
    ...
    kout.println("========================================");
    kout.println("  RP2040 Kernel v9.5");
    kout.println("  Task Termination Fix");
    kout.println("========================================");
...
kout.println(" MB");
    ...
    kout.println("- Exited apps are now correctly terminated.");
    kout.println("- Try 'snake' to test the new system.");
    
    kout.println("\nType 'help' for commands");
klog(0, "KERNEL: Boot complete v9.5");
